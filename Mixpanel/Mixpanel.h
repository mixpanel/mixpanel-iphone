...
#else
#define MIXPANEL_FLUSH_IMMEDIATELY 0
#define MIXPANEL_NO_APP_LIFECYCLE_SUPPORT 0
#endif

#if (defined(MIXPANEL_WATCHOS) || defined(MIXPANEL_MACOS))
#define MIXPANEL_NO_UIAPPLICATION_ACCESS 1
#else
#define MIXPANEL_NO_UIAPPLICATION_ACCESS 0
#endif
...
#else
#define MIXPANEL_NO_REACHABILITY_SUPPORT 0
#define MIXPANEL_NO_AUTOMATIC_EVENTS_SUPPORT 0
#define MIXPANEL_NO_NOTIFICATION_AB_TEST_SUPPORT 0
#define MIXPANEL_NO_CONNECT_INTEGRATION_SUPPORT 0
#endif
