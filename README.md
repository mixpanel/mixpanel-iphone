...
# Quick Start Guide
Caution: From version 4.0.0.beta.3 to version v4.1.0, we have a bug that events with ampersand(&) will be rejected by the server. We recommendate you update to 4.1.1 or above.
