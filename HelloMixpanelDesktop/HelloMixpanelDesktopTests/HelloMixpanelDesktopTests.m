...
#import "HelloMixpanelDesktopTests.h"
...
@interface HelloMixpanelDesktopTests ()  <MixpanelDelegate>

@property(nonatomic,retain) Mixpanel *mixpanel;

@end

@implementation HelloMixpanelDesktopTests
