Pod::Spec.new do |s|
  ...
  s.tvos.exclude_files = 'Sources/MixpanelWatchProperties.{m,h}'
  ...
  s.watchos.exclude_files = 'Sources/AutomaticEvents.{m,h}'
  ...
  s.osx.exclude_files = 'Sources/AutomaticEvents.{m,h}'
